...
| [commits/v028/](commits/v028/) · [commits/v029/](commits/v029/) | The `bobframes ui` zero-dep local-web control panel (v0.2.8, ADR-47) that drives the verbs for QA/product, **plus** its v0.2.9 polish track (v029_0..13, each review finding its own commit). | The panel tracks |
